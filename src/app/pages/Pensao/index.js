...
export function Pensao(props) {
    ...
    const step1SchemaValidation = yup.object().shape({
        ...
        monthly_payment_type: yup.object().nullable().required('Este campo é obrigatório!'),
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, {setSubmitting}) => {
            ...
            dispatch({type: 'REPORT_CHILDCARE', payload: {
                ...submitValues,
                setSubmitting,
                callback: () => {
                    setStep(3);
    ...
    useEffect(() => {
        ...
        console.log({            name: (calculation.calculation.name || ''),
        ...
        monthly_payment_type: (calculation.calculation.monthly_payment_type || null),
    ...
    <BlockUi tag="div" blocking={calculation_loading}>
        <h1 className="azul-cabecalho">CALCULADORA DE PENSÃO</h1>
        <p className="subheader-text mb-10">Realize cálculos de pensões alimentícias facilmente.</p>
