...
export default function Step4(props) {
    ...
    const report_rent = useSelector(state => state.app.report_rent);
...
<>
        <div className="row mb-10">
            <div className="col-xl-12">
                ...
                {Object.keys(report_rent).length > 0 &&
                <>
                    <div className="row mb-5">

                        <div className="d-flex" style={{cursor: 'pointer'}} onClick={() => window.open(report_rent.pdf_filename)}>
                    ...
                    <div className="row mb-5">
                        <div className="d-flex" style={{cursor: 'pointer'}} onClick={() => window.open(`${process.env.REACT_APP_API_URL}/${report_rent.pdf_complete_filename}`)}>
                            <a href="#" className="btn btn-icon btn-light-success pulse pulse-success mr-5" style={{color: '#41C78F !important'}}>
                                <i className="flaticon2-protected"></i>
                                <span className="pulse-ring"></span>
                            </a>
