...
export function Prev(props) {
    ...
    const salvarVinculo = (vinculo) => {
        ...
        if (vinculo.id) {
            ...
            tmpVinculos.push({
                ...
                activity_type: vinculo.activity_type,
    ...
    return (
        <BlockUi tag="div" blocking={is_processing_pdf || is_report_prev_loading}>
            ...
            <h1 className="azul-cabecalho">Calculadora Previdenciária</h1>
            <p className="mb-10" style={{ fontSize: '15px', opacity: '0.6' }}>Realize cálculos previdenciários facilmente.</p>
        { step == 0 &&
            <div className="defaultContent">
                <div className="container">
                    ...
                    { screen == 'atividades' &&
                    <>
                        <div className="col-4 p-10 pl-15">
                            <Upload formik={formik} onChooseFile={onChooseFile} />

                            <span className="title mb-5">Preencha os dados abaixo</span>
                            <div className="row">
                                <div className="col mb-5">
                                    <label className="form-label">NOME DO SEGURADO</label>
                                    <input
                            ...
                            <div className="row">
                                <div className="col-xl-3 d-flex flex-column">
                                    ...
                                    />
                                    {formik.errors.sexo && formik.touched.sexo && <label style={{ color: '#F64E60', fontSize: '0.9rem', marginTop: '0.25rem', width: '230px', display: 'block' }}>{formik.errors.sexo}</label>}
                                </div>
                            </div>

                            <button className="btn btn-primary btnDefault mt-10" onClick={calcular}>Efetuar cálculo</button>
                        </div>
