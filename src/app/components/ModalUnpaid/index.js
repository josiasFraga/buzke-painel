    ...
    return (
        ...
        >
            <Modal.Body>
                ...
                <br/>
                <br/>
                <a href="https://api.whatsapp.com/send?phone=5511933304069&text=" target="_BLANK">Entrar em contato via Whatsapp</a>
                <br/>
                <br/>
                <a href="https://app.jusfy.com.br/logout">Sair do sistema</a>
            </Modal.Body>
        </ResponsiveModal>
    ); 
}