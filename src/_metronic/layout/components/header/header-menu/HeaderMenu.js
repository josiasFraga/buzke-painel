                        ...
                        <ul className="menu-content">
                            <li className="menu-item ">
                                ...
                                <ul className="menu-inner">
                                    {/*begin::3 Level*/}
                                    <li className={`menu-item ${getMenuItemActive('/react-bootstrap/pagina1')}`}>
                                        <NavLink className="menu-link" to="/react-bootstrap/pagina1">
                                            <span className="menu-text">Página 1</span>
                                        </NavLink>
                                    </li>
                                    {/*end::3 Level*/}
